...
public class c5_CreatingSequence {
    ...
    public void repeat() {
        ...
        Callable<Integer> counterIncrementer = counter::incrementAndGet;
        Flux<Integer> repeated = Mono.fromCallable(counterIncrementer).repeat(9);
    ...
    public void generate_programmatically() {
        ...
        Flux<Integer> createFlux = Flux.create(sink -> {
            IntStream.rangeClosed(0, 5).forEach(sink::next);
            sink.complete();
        });
